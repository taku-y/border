...
//! ## Example
//! 
//! Here is an example of using the crate, where a random controller ([`Policy`]) is applied
//! to [`cartpole-v1`] environment of [Gym].
//! 
//! ```no_run
//! use anyhow::Result;
//! use border_core::{
...
//! [`PyGymEnvActFilter`] trait. The trait has a method that converts `Act`s
...
//! should be initialized with a configuration, regardless of if there are configurable
